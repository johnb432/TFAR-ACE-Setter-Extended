...
- **TFAR:** `x.x.x` [e.g. 1.1.0 stable, TFAR beta, commit hash]
- **TFAR - ACE Radio Setter - Extended:** `1.x.x` [e.g. 1.0.0 stable, commit hash]
<!-- Make sure to reproduce the issue with only CBA, ACE, TFAR and TFAR - ACE Radio Setter - Extended on a newly created mission! -->

**Description:**
A clear and concise description of what the bug is.

**Steps to reproduce:**
_Follow [this flowchart](https://ace3.acemod.org/img/wiki/user/issue_flowchart.webp) (Replace 'ACE3' with 'TFAR - ACE Radio Setter - Extended', ignore any 'Slack' mentions)!_
