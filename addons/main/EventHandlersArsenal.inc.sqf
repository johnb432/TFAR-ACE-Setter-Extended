...
["ace_arsenal_displayClosed", {
    // If the arsenal was opened on another unit, ignore
    if (GETMVAR("ace_arsenal_center",objNull) isNotEqualTo (call CBA_fnc_currentUnit)) exitWith {};
...
[missionNamespace, "arsenalClosed", {
    // If the arsenal was opened on another unit, ignore
    if (GETMVAR("BIS_fnc_arsenal_center",objNull) isNotEqualTo (call CBA_fnc_currentUnit)) exitWith {};
